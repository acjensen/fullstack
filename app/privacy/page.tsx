  ...
  return (
    <div className="flex max-w-screen-md m-6">
      <div>
        ...
        <p>
          This privacy policy applies to the fullstack app (hereby referred to
          as "Application") for mobile devices that was created by Andrew Jensen
        ...
        <p>
          ...
          identifiable information, including but not limited to Email, favorite
          color. The information that the Service Provider request will be
        ...
        <p>
          ...
          Application, please contact them at andrew.charles.jensen@gmail.com
        ...
        <div>
          ...
          <p>
            ...
            (andrew.charles.jensen@gmail.com) so that they will be able to take
        ...
        <br />
        <p>This privacy policy is effective as of 2024-03-22.</p>
        <br />
        ...
        <p>
          ...
          Service Provider via email at andrew.charles.jensen@gmail.com.
        </p>
      </div>
    </div>
  );
